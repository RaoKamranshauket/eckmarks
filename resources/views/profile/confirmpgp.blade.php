...
@section('profile-content')
    ...
    <form method="POST" action="{{ route('profile.pgp.store') }}" class="form-inline">
        ...
        <input type="number" class="form-control mx-2" required name="validation_number" value="{{{ session() -> get(\App\Marketplace\PGP::NEW_PGP_VALIDATION_NUMBER_KEY) }}}" id="validation_number"/>
